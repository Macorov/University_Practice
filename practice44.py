...
print(m)
file = open("bracufile1.txt","w") #erase the previous text and add new texts
file = open("bracufile1.txt","a") #starts writing from the end of the text if file exist it is called append mode
